...
export {
  ...
  initializeArticleBookmarkModel,
  getArticleBookmarkModel,
  ArticleBookmark,
} from './articleBookmark';
export {
  IArticleTag,
  ArticleTagModel,
  initializeArticleTagModel,
  getArticleTagModel,
  ArticleTag,
} from './articleTag';
